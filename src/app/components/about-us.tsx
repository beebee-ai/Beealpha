...
import { Globe, User, Briefcase, Brain, Quote } from "lucide-react";
             ...
             <div className="bg-[#111] p-8 sm:p-12 rounded-2xl border border-gray-800 hover:border-[#f7931e]/30 transition-colors space-y-12">
               ...
               <div className="bg-[#0a0a0a] rounded-xl p-6 sm:p-8 border border-gray-800/50">
                 <div className="flex items-center gap-3 mb-6">
                   ...
                   <h5 className="text-lg font-bold text-[#f7931e]">
                     {isEn ? "Professional Experience" : "职业经历"}
                   </h5>
                 </div>
                 <ul className="space-y-4 text-gray-300 text-sm sm:text-base leading-relaxed">
                   <li className="flex gap-3">
                     <span className="text-[#f7931e] mt-1.5">•</span>
                     <span>
                       <strong className="text-white">BEEBEE AI</strong> - 
                       {isEn 
                   ...
                   <li className="flex gap-3">
                     <span className="text-[#f7931e] mt-1.5">•</span>
                     <span>
                       <strong className="text-white">{isEn ? "Cheetah Mobile" : "猎豹移动"}</strong> - 
                       {isEn
                   ...
                   <li className="flex gap-3">
                     <span className="text-[#f7931e] mt-1.5">•</span>
                     <span>
                       <strong className="text-white">{isEn ? "Quwan Network" : "趣玩网"}</strong> - 
                       {isEn
                   ...
                   <li className="flex gap-3">
                     <span className="text-[#f7931e] mt-1.5">•</span>
                     <span>
                       <strong className="text-white">{isEn ? "Baidu" : "百度"}</strong> - 
                       {isEn
                   ...
                   <li className="flex gap-3">
                     <span className="text-[#f7931e] mt-1.5">•</span>
                     <span>
                       <strong className="text-white">{isEn ? "Top Software & Hero" : "托普软件 & 豪杰超级解霸"}</strong> - 
                       {isEn
               ...
               <div className="bg-[#0a0a0a] rounded-xl p-6 sm:p-8 border border-gray-800/50">
                 <div className="flex items-center gap-3 mb-6">
                   ...
                   <h5 className="text-lg font-bold text-[#f7931e]">
                     {isEn ? "Entrepreneurial Philosophy" : "创业理念"}
                   </h5>
                 </div>
